...
;Purpose: p1 for assignment 2, adding two numbers from user input
BITS 32
...
_start:
    ...
    ;now we need to add the two numbers and store into result
    mov eax, [digit1]
    mov ebx, [digit2]
    add eax, ebx
    mov [result], eax
...
section .data
title db 'The Adding Program', 0xa ; define title
