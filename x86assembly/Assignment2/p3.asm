...
;Purpose: p3 for assignment 2, dividing two numbers from user input
BITS 32
...
_start:
    ...
    ;now we need to divide the two numbers and store into result
    ...
    ;result is a number, we have to add 48 to it to make it printable, we do the same to the remainder
    mov eax, [result]
    add eax, '0'
    mov [result], eax
